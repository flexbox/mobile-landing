...
These terms and conditions apply to the yolo app (hereby referred to as "Application") for mobile devices that was created by weshipit.today (hereby referred to as "Service Provider") as a Free service.
...
These terms and conditions are effective as of 2025-03-13

**Contact Us**

If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at z2qdm0yrm@mozmail.com.
...
export default function Privacy() {
  const title = `${translate('nav.privacy')} - ${appInfo.name}`;
  const description = translate('app.description');
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`${appInfo.websiteUrl}/privacy`} />
      ...
      <ScrollView className="flex-1 bg-white">
        <View className="relative w-full px-6 py-12 md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-16 lg:pb-28">
          <Markdown
            style={{
